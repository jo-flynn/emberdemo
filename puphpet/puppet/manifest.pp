...
define php_mod {
  if $name == 'php5-mongo' and $::operatingsystem == 'ubuntu' and ! defined(Apt::Key['C7917B12']) {
    apt::key { 'C7917B12': key_server => 'hkp://keyserver.ubuntu.com:80' }
    apt::ppa { 'ppa:chris-lea/mongodb-drivers': require => Apt::Key['C7917B12'] }
  }
